...
function hideComplete() {
    $('.incompletedHunts').removeClass('active').addClass('hide');
    $('.completedHunts').removeClass('hide').addClass('active');
    $('.completedHuntsButton').addClass('hide');
    $('.currentlyHuntingButton').removeClass('hide');
}

function hideIncomplete() {
    $('.completedHunts').removeClass('active').addClass('hide');
    $('.incompletedHunts').removeClass('hide').addClass('active');
