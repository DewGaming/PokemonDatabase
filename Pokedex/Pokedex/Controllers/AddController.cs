...
namespace Pokedex.Controllers
{
    ...
    public class AddController : Controller
    {
        ...
        [HttpGet]
        [Route("add_pokemon_availability_weather/{pokemonLocationDetailId:int}")]
        ...
        [ValidateAntiForgeryToken]
        [Route("add_pokemon_availability_weather/{pokemonLocationDetailId:int}")]
        public IActionResult PokemonLocationWeatherDetail(PokemonLocationWeatherDetail pokemonLocationWeatherDetail)
        {
            if (!this.ModelState.IsValid)
            {
                PokemonLocationWeatherDetailViewModel model = new PokemonLocationWeatherDetailViewModel()
                {
                    PokemonLocationDetailId = pokemonLocationWeatherDetail.PokemonLocationDetailId,
                    AllWeathers = this.dataService.GetObjects<Weather>("Name"),
                };
            ...
            return this.RedirectToAction("PokemonLocationSeasonDetail", "Add");
        }

        [HttpGet]
        [Route("add_pokemon_availability_season/{pokemonLocationDetailId:int}")]
        ...
        [ValidateAntiForgeryToken]
        [Route("add_pokemon_availability_season/{pokemonLocationDetailId:int}")]
        public IActionResult PokemonLocationSeasonDetail(PokemonLocationSeasonDetail pokemonLocationSeasonDetail)
        {
            if (!this.ModelState.IsValid)
            {
                PokemonLocationSeasonDetailViewModel model = new PokemonLocationSeasonDetailViewModel()
                {
                    PokemonLocationDetailId = pokemonLocationSeasonDetail.PokemonLocationDetailId,
                    AllSeasons = this.dataService.GetObjects<Season>("Name"),
                };
        ...
        [HttpGet]
        [Route("add_pokemon_availability_time/{pokemonLocationDetailId:int}")]
        public IActionResult PokemonLocationTimeDetail(int pokemonLocationDetailId)
        {
            ...
            {
                PokemonLocationDetailId = pokemonLocationDetailId,
                LocationId = this.dataService.GetObjectByPropertyValue<PokemonLocationDetail>("Id", pokemonLocationDetailId).LocationId,
                AllTimes = this.dataService.GetObjects<Time>("Name"),
            };
        ...
        [ValidateAntiForgeryToken]
        [Route("add_pokemon_availability_time/{pokemonLocationDetailId:int}")]
        public IActionResult PokemonLocationTimeDetail(PokemonLocationTimeDetail pokemonLocationTimeDetail)
        {
            if (!this.ModelState.IsValid)
            {
                PokemonLocationTimeDetailViewModel model = new PokemonLocationTimeDetailViewModel()
                {
                    PokemonLocationDetailId = pokemonLocationTimeDetail.PokemonLocationDetailId,
                    LocationId = this.dataService.GetObjectByPropertyValue<PokemonLocationDetail>("Id", pokemonLocationTimeDetail.PokemonLocationDetailId).LocationId,
                    AllTimes = this.dataService.GetObjects<Time>("Name"),
                };
