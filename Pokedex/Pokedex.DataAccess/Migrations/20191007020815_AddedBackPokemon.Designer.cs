...
namespace Pokedex.DataAccess.Migrations
{
    ...
    [Migration("20191007020815_AddedBackPokemon")]
    partial class AddedBackPokemon
    {
            ...
            modelBuilder.Entity("Pokedex.DataAccess.Models.PokemonTeamDetail", b =>
                {
                    ...
                    b.Property<int?>("PokemonTypeDetailId")
                        .IsRequired();
                    ...
                    b.HasIndex("PokemonTypeDetailId");
            ...
            modelBuilder.Entity("Pokedex.DataAccess.Models.PokemonTeamDetail", b =>
                {
                    ...
                    b.HasOne("Pokedex.DataAccess.Models.PokemonTypeDetail", "PokemonTypeDetail")
                        .WithMany()
                        .HasForeignKey("PokemonTypeDetailId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
