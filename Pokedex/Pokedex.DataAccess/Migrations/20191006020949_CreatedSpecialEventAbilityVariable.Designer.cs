...
namespace Pokedex.DataAccess.Migrations
{
    ...
    [Migration("20191006020949_CreatedSpecialEventAbilityVariable")]
    partial class CreatedSpecialEventAbilityVariable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pokedex.DataAccess.Models.PokemonTeam", b =>
                {
                    ...
                    b.Property<string>("FifthPokemonId");

                    b.Property<string>("FirstPokemonId")
                        .IsRequired();

                    b.Property<string>("FourthPokemonId");

                    b.Property<string>("SecondPokemonId");

                    b.Property<string>("SixthPokemonId");

                    b.Property<string>("ThirdPokemonId");
            ...
            modelBuilder.Entity("Pokedex.DataAccess.Models.Update", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Pokedex.DataAccess.Models.PokemonTeam", b =>
                {
                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "FifthPokemon")
                        .WithMany()
                        .HasForeignKey("FifthPokemonId");

                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "FirstPokemon")
                        .WithMany()
                        .HasForeignKey("FirstPokemonId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "FourthPokemon")
                        .WithMany()
                        .HasForeignKey("FourthPokemonId");

                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "SecondPokemon")
                        .WithMany()
                        .HasForeignKey("SecondPokemonId");

                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "SixthPokemon")
                        .WithMany()
                        .HasForeignKey("SixthPokemonId");

                    b.HasOne("Pokedex.DataAccess.Models.Pokemon", "ThirdPokemon")
                        .WithMany()
